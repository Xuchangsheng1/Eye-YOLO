...
def bbox_inner_multi_iou(box1, box2, ratio=0.8, xywh=True, eps=1e-7, Inner_GIoU=False, Inner_DIoU=False,
                         Inner_CIoU=False, Inner_EIoU=False, Inner_SIoU=False, Inner_WIoU=False, FocalLoss_=False):
