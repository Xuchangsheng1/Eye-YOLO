...
try:
    ...
    from .NewLoss.ioulossone import nwd, bbox_shape_iou, bbox_mpdiou, bbox_inner_multi_iou, bbox_piou, nwdiou, \
        bbox_effciou, bbox_xiou
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        try:
            ...
            if useloss == 'CIoU':
                ...
                iou = bbox_focal_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], CIoU=True,
                                           FocalLoss_='Focal_CIoU')
            elif useloss == 'Focal_SIoU':
                print('测试')
                iou = bbox_focal_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], SIoU=True,
                                           FocalLoss_='Focal_SIoU')
            elif useloss == 'Focal_EIoU':
                iou = bbox_focal_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], EIoU=True,
                                           FocalLoss_='Focal_EIoU')
            elif useloss == 'Focal_DIoU':
                iou = bbox_focal_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], DIoU=True,
                                           FocalLoss_='Focal_DIoU')
            elif useloss == 'Focal_WIoU':
                iou = bbox_focal_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], WIoU=True,
                                           FocalLoss_='Focal_WIoU')
            elif useloss == 'Focal_GIoU':
                iou = bbox_focal_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], GIoU=True,
                                           FocalLoss_='Focal_GIoU')
        except Exception as e:
            # print('使用默认的CIoU损失函数')
            iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=True)
        try:
